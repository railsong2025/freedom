...
description: Auxiliary portfolio diagnostics module using Alpaca MCP Server integration to fetch holdings and positions, then analyze allocation, risk, diversification, and performance. In Freedom_Multi_EN, Buffett may call this skill for supporting portfolio data; do not bypass Buffett for formal portfolio review, rebalancing, current BUY/SELL decisions, or "buffett开始". Use directly only for standalone diagnostics or when a project workflow explicitly calls it as an auxiliary module.
---
...
Analyze investment portfolios by integrating with Alpaca MCP Server to fetch real-time holdings data, then performing comprehensive diagnostics covering asset allocation, diversification, risk metrics, individual position evaluation, and rebalancing evidence. Generate detailed portfolio evidence reports for user awareness or for Buffett's final decision workflow.
...
## Project-Local Orchestration Boundary

Inside `/Users/newsong/Desktop/AIstudio/Freedom_Multi_EN`, this skill is an
auxiliary portfolio data and diagnostics module. It can be called by Buffett or
another project workflow to enrich holdings, allocation, and risk evidence, but
it must not replace the Buffett full workflow for formal portfolio review,
rebalancing, current BUY/SELL actions, or `buffett开始`.

If a request asks what to buy, sell, trim, add, or rebalance in this project,
defer to the project-local `buffett` skill and provide only supporting
portfolio evidence when explicitly requested.
...
- "What stocks should I buy or sell?" only when Buffett or another workflow is explicitly using this as supporting evidence; otherwise defer formal action to Buffett
...
- [Diagnostic implication for Buffett review]
...
**4.5 Buffett Decision Inputs:**
- **Stable evidence** - Position appears well-sized and thesis appears intact
- **Underweight evidence** - Opportunity may justify Buffett reviewing an add
- **Overweight evidence** - Size, valuation, or concentration may justify Buffett reviewing a trim
- **Exit-risk evidence** - Thesis deterioration may justify Buffett reviewing a sale
...
**Buffett Decision Input:** [Stable evidence / Underweight evidence / Overweight evidence / Exit-risk evidence]
**Rationale:** [1-2 sentence evidence summary; do not issue final trade action]
```

### Step 5: Rebalancing Evidence For Buffett

**Read references/rebalancing-strategies.md** for rebalancing approaches

Generate a rebalancing evidence packet. Do not produce final trade orders,
share quantities, or current BUY/SELL actions inside this skill when operating
inside Freedom_Multi_EN; pass the evidence to Buffett for formal decisions.
...
**Positions for Buffett to Review for Trim Risk:**
...
**Areas for Buffett to Review for Add Potential:**
...
**Cash Deployment Evidence:**
- If excess cash (>10% of portfolio), quantify the gap and opportunity set
- Prioritize evidence by opportunity and allocation gaps, leaving deployment
  decisions to Buffett

**5.3 Prioritization:**
Rank rebalancing evidence by priority:
1. **Immediate Review** - Risk reduction evidence such as concentrated positions
2. **High Priority Evidence** - Major allocation drift (>10% from target)
3. **Medium Priority Evidence** - Moderate drift (5-10% from target)
4. **Low Priority Evidence** - Fine-tuning and opportunistic adjustments

**Output:**
```markdown
## Rebalancing Evidence For Buffett

### Summary
- **Rebalancing Review Needed:** [Yes / No / Optional]
- **Primary Reason:** [Concentration risk / Sector drift / Cash deployment / etc]
- **Decision Owner:** Buffett final workflow

### Evidence Items

#### HIGH PRIORITY: Risk Reduction
**[SYMBOL] Concentration Review** from XX% vs target YY%
- **Exposure at Risk:** XX shares (~$XX,XXX)
- **Rationale:** [Overweight / Valuation extended / etc]
- **Tax Impact:** $X,XXX capital gain (est)
- **Final Action:** Defer to Buffett

#### MEDIUM PRIORITY: Asset Allocation
**[Sector/Asset Class] Underweight Review**
- **Target:** Increase from XX% to YY%
- **Candidate Evidence:** [SYMBOL1, SYMBOL2, SYMBOL3]
- **Sizing Decision:** Defer to Buffett

#### CASH DEPLOYMENT
**Current Cash:** $XX,XXX (XX% of portfolio)
- **Evidence:** [Deploy review / Keep optionality review / Risk reserve review]
- **Suggested Analysis Buckets:** [Sectors/stocks for Buffett review]

### Buffett Follow-Up Queue
1. [First evidence item - highest priority]
2. [Second evidence item]
3. [Third evidence item]
...
...
**Medium-Term Evidence Follow-Ups:**
- [ ] [Evidence follow-up 3]
- [ ] [Evidence follow-up 4]
...
- In Freedom_Multi_EN, do not tell the user to sell; explain specific concerns
  (valuation, thesis breakdown, concentration) as evidence for Buffett review
- Provide supporting data
- Offer alternative research candidates only as evidence inputs

**"What should I buy instead?"**
- In Freedom_Multi_EN, do not tell the user what to buy; identify allocation
  gaps and candidate evidence for Buffett review
...
- Provide timing evidence and defer final rebalance action to Buffett
...
- Evidence-based diagnostics with clear rationale
...
**Evidence Clarity:**
- Use diagnostic labels, not final trade action verbs
- Quantify exposure, drift, cash, P&L, and risk without specifying trade orders
- Priority levels (Immediate Review, High, Medium, Low)
- Supporting rationale for each Buffett decision input
...
- When: Analyzing individual holdings for position-status diagnostics
- Contains: Position analysis framework, thesis validation checklist, position sizing guidelines, and evidence criteria

**references/rebalancing-strategies.md**
- When: Developing rebalancing evidence for Buffett review
...
**Rebalancing:**
- "Should I rebalance?"
- "What evidence should Buffett review before buying or selling?"
...
**Position-Specific:**
- "What evidence should Buffett review for [SYMBOL]?"
- "Is [SYMBOL] overweight in my portfolio?"
- "What are the portfolio diagnostics for [SYMBOL]?"
